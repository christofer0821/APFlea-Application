          ...
          Center(
            child: Column(
              children: [
                ...
                Text(user?.email ?? "Unknown", style: const TextStyle(fontSize: 16, color: Color(0xFF333333))),
                Text("Name: ${displayName ?? 'Loading...'}", style: const TextStyle(fontSize: 18, color: Color(0xFF333333), fontWeight: FontWeight.bold)),
              ],
            ),
          ),
